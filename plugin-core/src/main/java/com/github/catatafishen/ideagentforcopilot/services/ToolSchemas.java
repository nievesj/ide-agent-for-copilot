...
public final class ToolSchemas {
    ...
    static {
        ...
        m.put("refactor", schema(new Object[][]{
            ...
            {PARAM_FILE, TYPE_STRING, "Path to the file containing the symbol"},
        ...
        m.put("replace_symbol_body", schema(new Object[][]{
            ...
            {PARAM_LINE, TYPE_INTEGER, "Optional: line number hint to disambiguate if multiple symbols share the same name"}
